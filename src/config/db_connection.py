...
class DatabaseConnection:
    ...
    def _init_database(self):
        ...
        cursor.execute('''
                 CREATE EVENT IF NOT EXISTS delete_old_warranties
                 ON SCHEDULE EVERY 1 DAY
                 DO
                     DELETE FROM warranty WHERE end_date < NOW() - INTERVAL 30 DAY;
             ''')
        ...
        if count == 0:
            cursor.execute('''
                ...
                VALUES (%s, %s, %s, %s, %s)
            ''', ('admin', '$2b$12$ziidPcZIfUh.b/0nvpoVJuN1HnWc9GfVvtfmh0laKp7gBazzqm0Tq', 'Quản trị viên mặc định', 'admin', 'active'))
